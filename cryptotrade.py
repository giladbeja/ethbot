...
browser.find_element_by_name("username").send_keys("giladbeja@yahoo.com")
browser.find_element_by_name("password").send_keys("Gb26092004")
sleep(1)
...
while True:
    ...
    if cur < 3001.01:
        ...
        if (ogp * 1.005 <= cur):
            ...
            print("CUR: ",cur," , OGP: ",ogp)
            print("Price needed to sell: {}".format(round(ogp*1.005,2)))
            print("Price needed to buy: {}".format(round(ogp/1.005,2)))
            print("Current money invested: {}".format(minv))
            print("Current profit: {}".format(prof))
        sleep(20)
"""